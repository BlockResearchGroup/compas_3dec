...
HERE = os.path.dirname("C:/Users/adellend/Code/compas_3dec/src/compas_3dec/Analysis/WIP/WIP_Barrel/")

# ==============================================================================
# Init empty assembly
# ==============================================================================file:///C:/Users/adellend/Code/compas_3dec/src/compas_3dec/analysis/WIP/WIP_Test_Arch/Arch.3dm
...
for b in it.block.list():
    ...
    unbalanced_force_vec = (
        round(vec.vec3.x(unbalanced_force) / 1000, 6),
        round(vec.vec3.y(unbalanced_force) / 1000, 6),
        round(vec.vec3.z(unbalanced_force) / 1000, 6),
    )
